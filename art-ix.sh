...
#####################
########Repos#######
sudo pacman -S --noconfirm --needed base-devel kitty alsa-tools alsa-utils audacious audacious-plugins firefox gvfs htop lxappearance maim mesa glu libva-mesa-driver vulkan-radeon mesa-vdpau libvdpau libva-vdpau-driver mpv neofetch feh ntfs-3g pavucontrol pipewire libpipewire pipewire-alsa pipewire-pulse picom polybar rofi sxhkd tar unzip unrar p7zip thunar xclip xorg yt-dlp fish wget curl aria2 ripgrep gcc make htop firejail git viewnior xdg-user-dirs icewm neovim xorg-xsetroot gd libxft xf86-input-libinput xf86-video-amdgpu xorg-setxkbmap xorg-xrandr arandr xorg-xrdb xorg-xset xorgproto xorg-server xorg-server-common xorg-xauth xorg-xhost xdg-utils xcb-proto xcb-util zip udev psmisc harfbuzz acpi acpid acpid-s6 alsa-firmware alsa-lib alsa-plugins alsa-topology-conf alsa-ucm-conf alsa-utils alsa-utils-s6 atril bzip2 ca-certificates ca-certificates-mozilla ca-certificates-utils chromaprint connman-gtk curl dbus dbus-glib dbus-s6 ntfs-3g dosfstools efibootmgr efivar elogind elogind-s6 ffmpeg ffmpegthumbnailer ffmpegthumbs freetype2 udisks2 imlib2 fzf rustup
...
####AUR####
# paru -S mcomix obsidian-bin pamixer fluent-cursor-theme-git fluent-icon-theme-git
